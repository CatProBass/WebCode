	...
	<div class="wpexpert-help-tab">
		<div class="feature-section">
			...
			<div class="wpexpert-help-screenshot">
				<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/settings_1.png" />
			</div>
			...
			<div class="wpexpert-help-screenshot">
				<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/shortcodes_1.png" class="wpexpert-help-screenshot"/>
			</div>
